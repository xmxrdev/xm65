...
enum {
    ...
    XM65_CLI_ASSEMBLE_TARGET    = 0x00000004,
    XM65_CLI_VM_CONFIG          = 0x00000008,
    XM65_CLI_VERSION            = 0x00000010,
    XM65_CLI_HELP               = 0x00000020,

    XM65_CLI_RUN_TARGET         = XM65_CLI_EMULATE_TARGET | XM65_CLI_ASSEMBLE_TARGET,

    /* FLAGS*/
    XM65_CLI_TARGET_CHOSEN      = 0x00000040,
};
