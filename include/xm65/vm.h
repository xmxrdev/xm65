...
extern inline void     XM65_PrintCPU(XM65_VM*);
extern inline void     XM65_UpdateFlags(XM65_VM*, uint16_t, uint16_t, XM65_FLAG);
extern inline uint16_t XM65_ReadVector(XM65_VM*, uint16_t);
extern inline uint8_t  XM65_ReadOperand(XM65_VM*);
extern inline uint16_t XM65_ReadRelative(XM65_VM*);
extern inline uint16_t XM65_ReadIndirectOffset(XM65_VM*, uint8_t, uint8_t, bool);
extern inline uint16_t XM65_ReadIndirectAbsolute(XM65_VM*, bool);
extern inline uint16_t XM65_ReadAbsolute(XM65_VM*, uint8_t, bool);
extern inline uint16_t XM65_AddCarry(XM65_VM*, uint8_t);
extern inline uint16_t XM65_SubstractCarry(XM65_VM*, uint8_t);
extern inline void     XM65_StackPush(XM65_VM*, uint8_t);
extern inline uint8_t  XM65_StackPull(XM65_VM*);
